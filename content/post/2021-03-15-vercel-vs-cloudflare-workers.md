...
![A drawing of Cloudflare Edge Network showing how a user serverless function request is propagated](/blog/images/vercel-vs-cloudflare/cloudflare.png)
...
![A drawing of Vercel Edge Network showing how a user serverless function request is propagated](/blog/images/vercel-vs-cloudflare/vercel-cached.png)
...
![A drawing of Vercel Edge Network showing how a user serverless function request is propagated](/blog/images/vercel-vs-cloudflare/vercel.png)
...
![A screenshot from Cloudflare website with a world map showing locations of Cloudflare Network](/blog/images/vercel-vs-cloudflare/cloudflare-network.png)
<div class="code-descr">A screenshot from <a href="https://www.cloudflare.com/network/">Cloudflare website</a> with a world map showing locations of Cloudflare Network Datacenters</div>
...
![A screenshot from the Cloudflare Workers playground](/blog/images/vercel-vs-cloudflare/cf-playground.png)
<div class="code-descr">A screenshot from the Cloudflare Workers playground</div>
